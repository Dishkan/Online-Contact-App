                            ...
                            <tbody >
                                @foreach ($contacts as $contact)
                                    <tr>
                                        ...
                                        <td class="table-text"><div>{{ $contact->number }}</div></td>
                                        <td style="text-align: center;" class="table-text"><div> 
                                        ...
                                        <td>
                                            <form action="{{ route('main.destroy',$contact->id) }}" method="POST">
								<input type="hidden" name="_token" value="{{ csrf_token() }}">			
                                <input type="hidden" name="_method" value="DELETE" />
                                        ...
                                        <td>
										<a href="{{ route('main.edit', $contact->id) }}">
